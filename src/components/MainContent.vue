<template>
  <main class="container mx-auto my-8">
    ...
    <section class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
      <!-- Product Cards -->
      <div v-for="(product, index) in products" :key="index" class="bg-white p-4 rounded shadow-md">
        <img :src="product.image" :alt="`Product number ${index + 1}`" class="w-full h-48 object-cover mb-4">
